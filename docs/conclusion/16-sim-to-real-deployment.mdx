...
graph TD;
    ...
    subgraph "Sources of the Gap"
        C["<b>Unmodeled Physics</b><br/>Joint backlash, stiction, cable tension, link flexibility"] D["<b>Imperfect Actuation</b><br/>Motor torque ripple, battery voltage sag, communication latency"] E["<b>Sensor Noise</b><br/>Infrared interference, reflections, motion blur, calibration errors"] F["<b>Environmental Chaos</b><br/>Uneven floors, changing light, air currents"]
    end
    style A fill :#ccffcc
    style B fill :#ffcccc
`} />
