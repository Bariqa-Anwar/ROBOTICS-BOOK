...
**Independent Test**: A student with the specified hardware (RTX workstation + Jetson kit) can complete all tutorials from Chapter 1 to 12 and have a functioning, voice-controlled simulated humanoid that can walk, see, and manipulate objects.
...
-   **FR-005**: All code examples MUST be tested and functional on Ubuntu 22.04 with ROS 2 Humble/Iron and NVIDIA Isaac Sim 2023.1.1 or newer.
...
-   **SC-003**: An independent technical reviewer rates the book's coherence, practical utility, and accuracy at ≥ 8.5 out of 10.
