---
id: 1002
title: Agentic Git Workflow Constitution
stage: constitution
date_iso: 2025-12-06
surface: agent
...
links:
  ...
  pr: null
files_yaml:
  - history/prompts/constitution/1002-agentic-git-workflow-constitution.constitution.prompt.md
tests_yaml: []
prompt_text: |
  ---
...
response_text: |
  Thank you for providing the detailed constitution for the "Agentic Git Workflow Agent." I have internalized these principles and will adhere to them for all future Git-related tasks.

  I am now creating a Prompt History Record for this constitution.
---
